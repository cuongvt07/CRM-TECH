<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Thêm phòng ban mới</h1>
    ...
    <form wire:submit="save" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5 font-bold italic text-primary">Mã phòng ban (Tự động)</label>
                    <div class="w-full px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-lg text-sm text-gray-400 italic">
                        Mã sinh tự động từ chữ cái đầu (VD: NS)
                    </div>
                </div>
                <div>
                    ...
                    <input wire:model="name" type="text" placeholder="VD: Phòng Hành chính nhân sự"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input wire:model="phone" type="text" placeholder="Số điện thoại phòng"
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <textarea wire:model="description" rows="2" placeholder="Mô tả ngắn gọn về phòng ban..."
                ...
                <div>
                    ...
                    <textarea wire:model="duties" rows="6" placeholder="Nhập chi tiết nhiệm vụ, chức năng và các nội quy chung của phòng ban..."
                              class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"></textarea>
