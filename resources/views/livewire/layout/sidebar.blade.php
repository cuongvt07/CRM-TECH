<aside class="w-64 bg-white shadow-md flex flex-col h-full border-r border-gray-200">
    <div class="h-16 flex items-center justify-center border-b border-gray-200">
        <h1 class="text-xl font-bold text-primary">ERP System</h1>
    </div>
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        <a wire:navigate href="/" class="{{ request()->is('/') ? 'bg-blue-50 text-primary font-semibold' : 'text-gray-600 hover:bg-gray-50' }} flex items-center p-3 rounded-lg transition-colors">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
            Dashboard
        </a>
        <a wire:navigate href="#" class="text-gray-600 hover:bg-gray-50 flex items-center p-3 rounded-lg transition-colors">
