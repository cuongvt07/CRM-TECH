<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Chỉnh sửa nhân viên</h1>
    ...
    <form wire:submit="save" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-medium text-gray-400 mb-1.5 font-bold italic">Mã nhân viên (Cố định)</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input wire:model="password" type="password" placeholder="Để trống nếu không đổi"
                ...
                <div>
                    ...
                    <input wire:model="password_confirmation" type="password" placeholder="Nhập lại mật khẩu mới"
